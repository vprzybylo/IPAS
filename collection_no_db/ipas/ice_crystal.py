...
class IceCrystal():
    ...
    def find_x_nearest_geoms(self, yz_pt):
        '''
        ...
        if yz_pt[0] in self.points['y']:  # closest point is on vertex
            ...
            distance, index = tree.query([yz_pt], k=6, n_jobs=-1)
            ...
            while is_btwn is False:
                ...
                #else:
                    #print('area', area, i)
                    #self._plot_crystal(A, B, yz_pt, 'k')
                    i+=1
    ...
    def _plot_crystal(self, A, B, yz_pt, color, view='y'):  
        '''
        ...
        ax.scatter(0, yz_pt[0], yz_pt[1], color='r', s=100)
        ax.scatter(self.points[self.points['y']==A['y']]['x'], A['y'], A['z'], c='b', s=100)
        ax.scatter(self.points[self.points['y']==B['y']]['x'], B['y'], B['z'], color='g', s=100)
        ax.set_xlabel('X')
        ax.set_ylabel('Y')
        ax.set_zlabel('Z')
        plt.show()