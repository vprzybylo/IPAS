...
def parallelize_clusters(phio, reqarr, save_plots=False,
    ...
    chreq = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    chphi = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    chphi2D = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ovrlp = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    S = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_ovrlp = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_S = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_majorax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_minorax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_cplx = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    dphigam = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_phi = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_phi = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_phi2D = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_phi2D = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_mjrax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_mjrax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_req = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_req = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_minor_axis = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_minor_axis = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_ovrlp = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_ovrlp = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_S = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_S = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_cplx = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_cplx = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    min_phi = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    max_phi = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    min_phi2D = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    max_phi2D = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    min_mjrax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    max_mjrax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    min_minor_axis = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    max_minor_axis = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    min_req = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    max_req = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_phi = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_phi2D = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_ovrlp = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_S = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_mjrax = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_minor_axis = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_req = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_cplx = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    poserr_d2 = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    negerr_d2 = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_d2 = np.ones(shape=(len(reqarr),(ncrystals1+ncrystals2)), dtype=np.float64)
    min_d2 = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    max_d2 = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    mean_d2 = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)
    ch_dd = np.zeros(shape=(len(reqarr),(ncrystals1+ncrystals2)-1), dtype=np.float64)

    find_N = np.zeros(shape=(len(reqarr),1), dtype=np.float64)
    f1 = open('find_N_lookup.dat',"a+")
    f2 = open('major_axis_lookup.dat',"a+")
    f3 = open('minor_axis_lookup.dat',"a+")
    f4 = open('dd_lookup.dat',"a+")
    ...
    for s in range(len(reqarr)):   #array of equivalent volume radii to loop through
        ...
        poserr_phi[s,:]=b1.poserr[:]
        negerr_phi[s,:]=b1.negerr[:]
        chphi[s,:]=b1.ch[:]
        min_phi[s,:]=b1.min_data[:]
        max_phi[s,:]=b1.max_data[:]
        mean_phi[s,:]=b1.mean[:]
        #print(chphi[i,s,:])
        #print('done with phi')

        b1.get_characteristics(var ='req', save=save_plots, minor = minor, ch_dist=ch_dist, verbose=False)
        poserr_req[s,:]=b1.poserr[:]
        negerr_req[s,:]=b1.negerr[:]
        chreq[s,:]=b1.ch[:]
        min_req[s,:]=b1.min_data[:]
        max_req[s,:]=b1.max_data[:]
        mean_req[s,:]=b1.mean[:]
        #print('done with req')

        b1.get_characteristics(var ='density_change', save=save_plots, minor = minor, ch_dist=ch_dist, verbose=False)
        poserr_d2[s,:]=b1.poserr[:]
        negerr_d2[s,:]=b1.negerr[:]
        ch_d2[s,:-1]=b1.ch[:]
        min_d2[s,:]=b1.min_data[:]
        max_d2[s,:]=b1.max_data[:]
        mean_d2[s,:]=b1.mean[:]
        ch_d2[s,:]= np.insert(ch_d2[s,:-1], 0, 1.0)
        #print('d1', ch_d2[i,s,:-1])
        #print('d2', ch_d2[i,s,1:])
        ch_dd[s,:] = (ch_d2[s,:-1] - ch_d2[s,1:])
        ...
        poserr_mjrax[s,:]=b1.poserr[:]
        negerr_mjrax[s,:]=b1.negerr[:]
        ch_majorax[s,:]= b1.ch[:]
        min_mjrax[s,:]=b1.min_data[:]
        max_mjrax[s,:]=b1.max_data[:]
        mean_mjrax[s,:]=b1.mean[:]
        ...
        poserr_minor_axis[s,:]=b1.poserr[:]
        negerr_minor_axis[s,:]=b1.negerr[:]
        ch_minorax[s,:]=b1.ch[:]
        min_minor_axis[s,:]=b1.min_data[:]
        max_minor_axis[s,:]=b1.max_data[:]
        mean_minor_axis[s,:]=b1.mean[:]
        #print('done with minor axis')


        #write out lookup tables
        for N in range(len(chphi[s,:])):
            #to find N

            f1.write('%.3f\t %.1f\t %.4f\t %.4f\t\n'%(phio, reqarr[s], chphi[s,N], chreq[s,N]))
            f1.flush()
            print(phio,reqarr[s],chphi[s,N], chreq[s,N])
            #major_axis
            f2.write('%.3f\t %.1f\t %.4f\t\n'%(phio, reqarr[s], ch_majorax[s,N]))
            print(phio, reqarr[s], ch_majorax[s,N])
            f2.flush()
    #minor_axis
            f3.write('%.3f\t %.1f\t %.4f\t\n'%(phio, reqarr[s], ch_minorax[s,N]))
            f3.flush()
    #density Change
            f4.write('%.3f\t %.1f\t %.4f\t\n'%(phio, reqarr[s], ch_dd[s,N]))
            f4.flush()
