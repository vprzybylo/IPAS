...
class PlotAgg:
    ...
    def get_scatter_plot_data(self, line_width=6):
        ...
        self.trace_basal_top = go.Scatter3d(
            x=x_basal_top,
            y=y_basal_top,
            z=z_basal_top,
            mode="lines",
        ...
        self.trace_basal_bottom = go.Scatter3d(
            x=x_basal_bottom,
            y=y_basal_bottom,
            z=z_basal_bottom,
            mode="lines",
    ...
    def scatter_ellipsoid(self, xell, yell, zell, x, y, z, line_width=2):
        ...
        self.ellipsoid_surface = go.Scatter3d(
            x=xell[0::4].flatten(),
            y=yell[0::4].flatten(),
            z=zell[0::4].flatten(),
            mode="lines",
        ...
        self.ellipsoid_radius_b1 = go.Scatter3d(
            x=xell[0, :].flatten(),
            y=yell[0, :].flatten(),
            z=zell[0, :].flatten(),
            mode="lines",
        ...
        self.ellipsoid_radius_b2 = go.Scatter3d(
            x=xell[20, :].flatten(),
            y=yell[20, :].flatten(),
            z=zell[20, :].flatten(),
            mode="lines",
        ...
        self.ellipsoid_radius_r1 = go.Scatter3d(
            x=xell[10, :].flatten(),
            y=yell[10, :].flatten(),
            z=zell[10, :].flatten(),
            mode="lines",
        ...
        self.ellipsoid_radius_r2 = go.Scatter3d(
            x=xell[30, :].flatten(),
            y=yell[30, :].flatten(),
            z=zell[30, :].flatten(),
            mode="lines",
        ...
        self.ellipsoid_radius_g1 = go.Scatter3d(
            x=xell[:, 20].flatten(),
            y=yell[:, 20].flatten(),
            z=zell[:, 20].flatten(),
            mode="lines",
    ...
    def closest_pts(
        ...
        self.mesh_mono1 = go.Scatter3d(
            x=x_mesh_mono1, y=y_mesh_mono1, z=z_mesh_mono1, showlegend=False
        )
        # grid mesh over monomer1
        self.mesh_mono2 = go.Scatter3d(
            x=x_mesh_mono2, y=y_mesh_mono2, z=z_mesh_mono2, showlegend=False
        )
        # closest mesh grid pt on monomer1
        # x value found after comparing closest grid pt to shapely returned nearest pt
        self.mesh_mono2 = go.Scatter3d(
            x=x_closest_clus, y=y_closest_clus, z=z_closest_clus, showlegend=False
        )
        # shapely closest pt on monomer2
        self.mesh_mono2 = go.Scatter3d(
            x=x_closest_mono, y=y_closest_mono, z=z_closest_mono, showlegend=False
        )
    ...
    def layout(
        ...
        self.layout = go.Layout(
            scene=dict(
                camera=self.camerax,
                xaxis=dict(
                    range=[self.minxyz, self.maxxyz],
                    title="X",
                    showgrid=showgrid,
                    tickangle=tick_angle,
                    showticklabels=showticklabels,
                    tickfont=dict(family=tick_fontfamily, size=tick_size),
                ),
                yaxis=dict(
                    range=[self.minxyz, self.maxxyz],
                    title="Y",
                    ...
                    tickangle=tick_angle,
                    showticklabels=showticklabels,
                    tickfont=dict(size=tick_size, family=tick_fontfamily),
                ),
                zaxis=dict(
                    range=[self.minxyz, self.maxxyz],
                    title="Z",
