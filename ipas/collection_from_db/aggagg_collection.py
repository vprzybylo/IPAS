...
def collect_clusters_agg_agg(clusters1, clusters2, rand_orient=False):
    ...
    for n in range(len(clusters1)):
        ...
        nearest_geoms_xz, nearest_geoms_yz, nearest_geoms_xy = cluster1.closest_points(
            cluster2
        )
        ...
        # DENSITY CHANGE ------------------
        # monomer a and c
        a1 = np.power((np.power(cluster1.monor, 3) / cluster1.monophi), (1.0 / 3.0))
        c1 = cluster1.monophi * a1
        a2 = np.power((np.power(cluster2.monor, 3) / cluster2.monophi), (1.0 / 3.0))
        ...
        Ve1 = 4.0 / 3.0 * np.pi * cluster1.a * cluster1.b * cluster1.c
        # volume of ellipsoid for clus2
        Ve2 = 4.0 / 3.0 * np.pi * cluster2.a * cluster2.b * cluster2.c
        # volume of ellipsoid for new agg
        Ve3 = 4.0 / 3.0 * np.pi * cluster3.a * cluster3.b * cluster3.c
        Vr1 = Va1 / Ve1
        Vr2 = Va2 / Ve2
